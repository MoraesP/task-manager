...
export const ICON_PATHS: Record<IconName, string> = {
  board:
    '<rect x="3" y="4" width="7" height="16" rx="1.5"/><rect x="14" y="4" width="7" height="10" rx="1.5"/>',
  ...
  'mail-plus':
    '<path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h9"/><path d="m2 7 10 6 10-6"/><path d="M19 16v6M16 19h6"/>',
};
