...
export type IconName =
  | 'board' | 'list' | 'chart' | 'users' | 'settings' | 'folder'
  | 'search' | 'plus' | 'chevron-down' | 'chevron-right' | 'chevron-left'
  | 'clock' | 'calendar' | 'lock' | 'check' | 'x' | 'dots' | 'filter'
  | 'arrow-left' | 'logout' | 'copy' | 'alert' | 'eye' | 'trash' | 'reopen' | 'mail-plus';
...
const PATHS: Record<IconName, string> = {
  ...
  'mail-plus': '<path d="M22 13V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h9"/><path d="m2 7 10 6 10-6"/><path d="M19 16v6M16 19h6"/>',
};
